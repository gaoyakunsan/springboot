...
(function($) {
  ...
  */
  $.smkConfirm = function(options, callback) {
    ...
    var bodyStr = '<div class="smk-confirm-back"><div class="panel panel-default smk-confirm" tabindex="1"><div class="panel-body">'
        + settings.text + '</div><div class="panel-footer text-right">';
    if (!(settings.type == 'tip')){
        bodyStr += '<a class="btn btn-default btn-sm smk-cancel" href="#" >' + settings.cancel + '</a> '
    }
    bodyStr += '<a class="btn btn-primary btn-sm smk-accept" href="#">' + settings.accept + '</a></div></div></div>';
